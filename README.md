...
```bash
git clone https://github.com/shritanu16007-ctrl/Skill-Alert-AI.git
cd Skill-Alert-AI
```
...
SkillAlert AI isn't just a learning tool; it's a **Career Intelligence Agent**. It solves the "What should I learn next?" problem by combining academic data with live industry signals, providing students with a verified, data-backed pathway to high-paying AI careers.

---
Created with ❤️ for the XE Hackathon.
